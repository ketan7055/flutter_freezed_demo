...
class _$CompanyImpl extends _Company {
  _$CompanyImpl(
      {this.name = 'ankit',
      @Assert('companySize >= 0') this.companySize,
  ...
  @override
  String toString() {
    return 'Company(name: $name, companySize: $companySize, director: $director)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, name, companySize, director);
...
abstract class _Company extends Company {
  factory _Company(
      {final String name,
      @Assert('companySize >= 0') final int? companySize,
      required final Director director}) = _$CompanyImpl;
  _Company._() : super._();
